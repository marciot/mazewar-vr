    ...
    _createClass(OverlayText, [{
        ...
        value: function createText(str) {
            ...
            for (var i = 0; i < lines.length; i++) {
                var _line = lines[i];
                summedHeight += _line.height;
                maxWidth = Math.max(_line.width, maxWidth);
            }
            ...
            var distance = MazeWalls.cellDimension / 2 * 0.9;
            var glWidth = distance * (2 * Math.tan(halfFovInRadians)) * coverage;
